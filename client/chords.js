...
const BbMajor6 = new chordObj("Bb3", "D4", "F4", "G4");
const BbMajorAdd9 = new chordObj("Bb3", "D4", "F4", "C5");
const CMajor = new chordObj("C4", "E4", "G4");
const CMajor7 = new chordObj("C4", "E4", "G4", "Bb4");
const CMajorAdd9 = new chordObj("C4", "E4", "G4", "D5");
const CMajor6 = new chordObj("C4", "E4", "G4", "A4");
const CMajor9 = new chordObj("C4", "E4", "G4", "Bb4", "D5");
const DMinor = new chordObj("D4", "F4", "A4");
const DMinor7 = new chordObj("D4", "F4", "A4", "C5");
const DMinor9 = new chordObj("D4", "F4", "A4", "C5", "E5");
const DMinorAdd9 = new chordObj("D4", "F4", "A4", "E5");
...
majorScaleChords.F.Am9 = AMinor9;
...
const GbMajor = new chordObj("Gb3", "Bb3", "Db4");
const GbMajorMaj7 = new chordObj("Gb3", "Bb3", "Db4", "Gb4");
const GbMajorMaj9 = new chordObj("Gb3", "Bb3", "Db4", "Gb4", "Ab4");
const GbMajorAdd9 = new chordObj("Gb3", "Bb3", "Db4", "Ab4");
const GbMajor6 = new chordObj("Gb3", "Bb3", "Db4", "Eb4");
const AbMinor = new chordObj("Ab3", "B3", "Eb4");
...
const BbMinor = new chordObj("Bb3", "Db4", "F4");
const BbMinor7 = new chordObj("Bb3", "Db4", "F4", "Ab4");
const BbMinor9 = new chordObj("Bb3", "Db4", "F4", "Ab4", "B4");
const BMajor = new chordObj("B3", "Eb4", "Gb4");
const BMajorMaj7 = new chordObj("B3", "Eb4", "Gb4", "Bb4");
const BMajorMaj9 = new chordObj("B3", "Eb4", "Gb4", "Bb4", "Db5");
const BMajor6 = new chordObj("B3", "Eb4", "Gb4", "Ab4");
const BMajorAdd9 = new chordObj("B3", "Eb4", "Gb4", "Db5");
const DbMajor = new chordObj("Db4", "F4", "Ab4");
const DbMajor7 = new chordObj("Db4", "F4", "Ab4", "B4");
const DbMajorAdd9 = new chordObj("Db4", "F4", "B4", "Eb5");
const DbMajor6 = new chordObj("Db4", "F4", "Ab4", "Bb4");
const DbMajor9 = new chordObj("Db4", "F4", "Ab4", "B4", "Eb5");
const EbMinor = new chordObj("Eb4", "Gb4", "Bb4");
const EbMinor7 = new chordObj("Eb4", "Gb4", "Bb4", "C5");
const EbMinor9 = new chordObj("Eb4", "Gb4", "Bb4", "C5", "E5");
const EbMinorAdd9 = new chordObj("Eb4", "Gb4", "Bb4", "E5");
...
majorScaleChords.Gb.Bbm9 = BbMinor9;
...
const BMinor9 = new chordObj("B3", "D4", "Gb4", "A4", "C5");
const CMajor = new chordObj("C4", "E4", "G4");
const CMajorMaj7 = new chordObj("C4", "E4", "G4", "B4");
const CMajorMaj9 = new chordObj("C4", "E4", "G4", "B4", "D5");
const CMajor6 = new chordObj("C4", "E4", "G4", "A4");
const CMajorAdd9 = new chordObj("C4", "E4", "G4", "D5");
...
const EMinor = new chordObj("E4", "G4", "B4");
const EMinor7 = new chordObj("E4", "G4", "B4", "D5");
const EMinor9 = new chordObj("E4", "G4", "B4", "D5", "Gb5");
const EMinorAdd9 = new chordObj("E4", "G4", "B4", "Gb5");
...
majorScaleChords.G.G6 = GbMajor6;
...
majorScaleChords.G.Bm9 = BMinor9;
...
const AbChords = ['Ab3', 'Bb3', 'C4', 'Db4', 'Eb4', 'F4', 'G4', 'Ab4', 'Bb4', 'C5', 'Db5', 'Eb5', 'F5', 'G5']
await Promise.all(AbChords.map(chord => Chord.create({
  chordName: chord,
    scaleId: Ab.id
  })))
...
majorScaleChords.Ab.G = GMajor;
majorScaleChords.Ab.GMaj7 = GMajorMaj7;
majorScaleChords.Ab.GMaj9 = GMajorMaj9;
majorScaleChords.Ab.Gadd9 = GMajorAdd9;
majorScaleChords.Ab.G6 = GbMajor6;
majorScaleChords.Ab.Am = AMinor;
majorScaleChords.Ab.Am7 = AMinor7;
majorScaleChords.Ab.Am9 = AMinor9;
majorScaleChords.Ab.Amadd9 = AMinorAdd9;
majorScaleChords.Ab.Bm = BMinor;
majorScaleChords.Ab.Bm7 = BMinor7;
majorScaleChords.Ab.Bm9 = BMinor9;
majorScaleChords.Ab.C = CMajor;
majorScaleChords.Ab.CMaj7 = CMajorMaj7;
majorScaleChords.Ab.CMaj9 = CMajorMaj9;
majorScaleChords.Ab.Cadd9 = CMajorAdd9;
majorScaleChords.Ab.C6 = CMajor6;
majorScaleChords.Ab.D = DMajor;
majorScaleChords.Ab.D7 = DMajor7;
majorScaleChords.Ab.Dadd9 = DMajorAdd9;
majorScaleChords.Ab.D6 = DMajor6;
majorScaleChords.Ab.D9 = DMajor9;
majorScaleChords.Ab.Em = EMinor;
majorScaleChords.Ab.Em7 = EMinor7;
majorScaleChords.Ab.Em9 = EMinor9;
majorScaleChords.Ab.Emadd9 = EMinorAdd9;
majorScaleChords.Ab.G5 = G5;
majorScaleChords.Ab.A5 = A5;
majorScaleChords.Ab.B5 = B5;
majorScaleChords.Ab.B5 = B5;
majorScaleChords.Ab.D5 = D5;
majorScaleChords.Ab.E5 = E5;
majorScaleChords.Ab.Gbdim = gbDim;
